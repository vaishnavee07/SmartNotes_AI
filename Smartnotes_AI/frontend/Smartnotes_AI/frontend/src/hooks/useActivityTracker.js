...
const useActivityTracker = (page) => {
    ...
    useEffect(() => {
        ...
        const flushAndSave = async () => {
            ...
            if (totalMinutes < 1) {
                console.log(`[ActivityTracker] ${s.page}: session too short (${totalMinutes.toFixed(2)} min) — skipped`);
                return;
            }
            ...
            console.log(`[ActivityTracker] Saving ${safeDuration.toFixed(2)} min for page: ${s.page}`);
            ...
            try {
                ...
                console.log(`[ActivityTracker] ✓ Saved ${safeDuration.toFixed(2)} min for ${s.page}`);
            } catch (err) {
