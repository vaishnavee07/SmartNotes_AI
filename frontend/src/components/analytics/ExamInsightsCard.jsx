...
import { Rocket, AlertTriangle, Zap, TrendingUp, Award, Brain, Target } from 'lucide-react';
...
const ExamInsightsCard = () => {
    ...
    useEffect(() => {
        api.get('/analytics/readiness')
            ...
            .catch(err => console.error('[ExamInsightsCard]', err))
    ...
    const demo = data?.examInsightsSummary || {
        currentReadiness:    0,
            ...
            <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {insights.slice(0, 4).map((insight, i) => (
                        ...
                        >
                            <span className="text-lg shrink-0 text-slate-400">
                                {i === 0 ? <AlertTriangle size={18} className="text-amber-500 mt-0.5" /> : 
                                 i === 1 ? <Target size={18} className="text-blue-500 mt-0.5" /> : 
                                 i === 2 ? <TrendingUp size={18} className="text-emerald-500 mt-0.5" /> : 
...
export default ExamInsightsCard;
