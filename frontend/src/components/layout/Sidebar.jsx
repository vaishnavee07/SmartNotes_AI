...
import { Home, BookOpen, Layers, Target, LogOut, Brain, FileText, Flame, MessageSquare, BarChart2 } from 'lucide-react';
...
const Sidebar = () => {
    ...
    const navItems = [
        ...
        { name: 'AI Tutor', icon: MessageSquare, path: '/ai-tutor' },
        ...
        { name: 'Exam Readiness', icon: BarChart2, path: '/exam-readiness' },
    ];
